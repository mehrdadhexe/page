            ...
            <div class="bar-wrapper">
                        ...
                        <div class="col-lg-13 col-md-11 clearfix mobile">
                            <div class="dropdown dropdown-1">
                                ...
                                <ul class="dropdown-menu">
                                   ...
                                   @endforeach
                                    <li>
                                        <a href="#" type="button" data-toggle="modal" data-target="#mapModal"
                        ...
                        <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                            ...
                            <div class="login-dropdown clearfix">
                                <a data-toggle="dropdown" href="#Page" class="dropdown-toggle" aria-expanded="false">
                                    <div style="background-image:url(/assets/site/img/user-pic.png)" class="avatar inline-block"></div>
				...
				<p class="credit">
					<span>موجودی: ۰ تومان</span>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="/user/userProfiles/index#tab1" data-tab="#tab1"><span><i class="icon icon-user-avatar"></i></span>ویرایش پروفایل شخصی</a></li>
                                    ...
                                    <li><a href="/user/userProfiles/index#tab3" data-tab="#tab3"><span><i class="icon icon-logo_e"></i></span>نت
                                            برگ های من</a></li>
                                    <li><a href="/user/userProfiles/index#tab4" data-tab="#tab4"><span><i class="icon icon-transaction"></i></span>تراکنش ها</a></li>
                                    <li><a href="/user/userProfiles/index#tab5" data-tab="#tab5"><span><i class="icon icon-Comment"></i></span>نظرات
                                            من</a></li>
                                    <li><a href="/user/userProfiles/index#tab6" data-tab="#tab6"><span><i class="icon icon-favorite"></i></span>علاقه
                                            مندی ها</a></li>
                                    <li>
                                        <a href="{{ route('logout') }}"
                                           onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><span><i class="icon icon-logout"></i></span>خـروج</a>
